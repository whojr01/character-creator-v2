...
function App() {
  ...
  return (
    <main className={styles.characterEditor}>
      ...
      {/* I moved this from App.jsx to be included in the component where it belongs.
      
        Also I learned that to apply styles use reference it with the styles.[style]. DAH! Doh! {Head slap}
      */}
